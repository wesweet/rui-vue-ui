Function && Function.prototype && Function.prototype.bind && (/(MSIE ([6789]|10|11))|Trident/.test(navigator.userAgent) || (window.__twttr && window.__twttr.widgets && window.__twttr.widgets.loaded && window.twttr.widgets.load && window.twttr.widgets.load(), window.__twttr && window.__twttr.widgets && window.__twttr.widgets.init || function (t) {
    ...
    t.exports = function (t) {
        t.params({
            ...
            return this.params.isPreconfigured && !this.params.height && (t = h), f.compact({
                dnt: c.enabled(),
        ...
        function D(e, n, r, i) {
            ...
            if (o) {
                if ((s = function (t, e) {
                    ...
                    }(r, i)) === S ? (c = !0, a = s.error, s.error = null) : u = !0, n === s) return void I(n, new TypeError("A promises callback cannot return that same promise."))
            } else s = i, u = !0;
    ...
    t.exports = function (t, e, n, f) {
        var h, p = s.get(t.id);
        return i.isHorizonTimelineEnabled(f, p) ? (h = r.createElement("div"), new o(u, a, l.TIMELINE, t, e, n, {
            sandboxWrapperEl: h
    ...
    t.exports = {
        tweetButtonHtmlPath: "/widgets/tweet_button.8f764d5bd2778f88121d31d7d8d8e1e3.{{lang}}.html",
        followButtonHtmlPath: "/widgets/follow_button.8f764d5bd2778f88121d31d7d8d8e1e3.{{lang}}.html",
    ...
    function p(t, e, n, r) {
        var u;
        n && a.isObject(t) && a.isObject(e) && (i.log(t, e), u = s.flattenClientEventPayload(t, e), r = a.aug({}, r, {
            l: s.stringify(u)
        }), u.dnt && (r.dnt = 1), w(o.url(n, r)))
    }
    ...
    var r, i = n(2),
        ...
        m = n(30),
        v = n(36);
    n(162), m.emitter.trigger(m.START), u.set("widgets.init", !0), a.set("init", !0), p(), r = new i, s.exposeReadyPromise(r.promise, a.base, "_e"), a.set("widgets", f), a.set("widgets.load", l.load), a.set("events", d), h(function () {
